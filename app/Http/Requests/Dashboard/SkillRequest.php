...
class SkillRequest extends FormRequest
{
    ...
    {
        return [
            'name_ar'            => 'required|string|unique:skills,name_ar,' . $this->id,
            'name_en'            => 'sometimes|nullable|unique:skills,name_en,' . $this->id,
            'name_fr'            => 'sometimes|nullable|unique:skills,name_fr,' . $this->id,
        ];
    }
    /**
    * messages
