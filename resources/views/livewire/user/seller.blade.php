<div class="flex flex-col">
  ...
  <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
    ...
    <input class="w-1/3 rounded my-2"  type="text" wire:model='search' placeholder="ابحث عن المستخدمين" />
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="flex-shrink-0 h-10 w-10 ml-4">
                    <img class="h-10 w-10 rounded-full" src="{{asset('images/'.$seller->profile->avatar) }}" alt="">
                  </div>
                  <div class="ml-4">
